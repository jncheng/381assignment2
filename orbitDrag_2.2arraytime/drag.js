...
var audio = new Audio('audio/sauceboss.mp3');
...
function drawMathProblem(x, y)
{
  ...
  // <audio src="/audio/sauceboss.mp3" preload="auto" />
  audio.play();
  var numMathAnswer;
...
// function storeTime(hVal, mVal, array) {
//     array.push({h: hVal, m: mVal});
// }

// var alarmTime = [];
// storeTime(alarmHour, alarmMinute, alarmTime);


// alarmTime[0].h == alarmHour;   // x value
// alarmTime[0].m == alarmMinute;   // y value
...
//   d = new Date();
//     if(alarmTime[i].h == d.getHours() && alarmTime[] == d.getMinutes() && alarmSet == true){
//     console.log('1');
//     alarmOn = true;
